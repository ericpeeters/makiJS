    ...
    create: function() {
        ...
        if (settings.content.length && settings.copyControls == true) {
            ...
            $.each(settings.content, function(i, e) {
                ...
                var $makiWrapper = $('<div class="makiWrapper clearfix"><div class="makiBtnWrapper"><button class="btnCopymaki">Copy maki</button> <button class="btnCopyHTML">Copy HTML</button></div></div>').data('maki', e),
